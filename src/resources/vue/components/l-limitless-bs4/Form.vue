            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item">Financial Accounting</span>
                        <span class="breadcrumb-item">Journal Entries</span>
                ...
                <div class="header-elements">
                    <div class="breadcrumb justify-content-center">
                        <router-link to="/journal-entries" class=" btn btn-danger btn-sm rounded-round font-weight-bold">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <model-list-select :list="globalsCurrencies"
                                                       v-model="txnAttributes.currency"
                                                       option-value="value"
                                                       option-text="text"
                            ...
                            <div class="form-group row">
                                <table class="table table-bordered border-left-0 border-right-0 border-bottom-0">
                                    ...
                                    <tbody id="items_field_rows">
                                        ...
                                        <tr v-for="(recording, index) in txnAttributes.recordings">
                                            <td class="td_item_selector p-0 rg_select2_border_none">
                                                <model-list-select :list="txnAccounts"
                                                                   v-model="recording.financial_account_code"
                                                                   option-value="id"
                                                                   option-text="name"
                                            ...
                                            <td class="p-0">
                                                <input type="text"
                                                       v-model.number="recording.debit"
                                            ...
                                            <td class="p-0">
                                                <div style="position: relative">
                                                    <div class="input-group">
                                                        <input type="text"
                                                               v-model.number="recording.credit"
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td class="border-0" colspan="2">
                                                <button type="button" class="btn btn-link pt-0 pb-0 font-weight-bold" @click="txnRecordingCreate">
    ...
    export default {
        ...
        methods: {
            ...
            journalTotals() {
                ...
                this.txnAttributes.recordings.forEach((recording) => {

                    recording.type = 'account' //always
                    recording.quantity = 1 //always
                    ...
                    if (recording.debit > 0) {

                        recording.effect = 'debit'
                        recording.rate = recording.debit
                        recording.total = recording.debit
                        this.txnAttributes.totalDebit += recording.debit

                        this.txnAttributes.total += recording.debit

                    } else {

                        recording.effect = 'credit'
                        recording.rate = recording.credit
                        recording.total = recording.credit
                        this.txnAttributes.totalCredit += recording.credit

                    }

                    recording.displayTotal = recording.total

                    this.txnAttributes.total += recording.total

                })

            },
            txnRecordingCreate() {
                this.txnAttributes.recordings.push({
                    selectedItem: {},
                    selectedTaxes: [],
