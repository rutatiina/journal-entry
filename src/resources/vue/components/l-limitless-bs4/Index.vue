            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Journal Entries</span>
                    </div>
                    ...
                    <table class="table table-hover">
                        <thead class="">
                            <tr class="table-active">
                                <!--
                                <th class="col-auto font-weight-bold" style="width: 20px;">
                                ...
                                -->
                                <th class="col-auto font-weight-bold">Date</th>
                                <th class="col font-weight-bold" nowrap="">Reference</th>
                                <th class="col font-weight-bold text-right" nowrap>Total</th>
                            </tr>
                        </thead>
...
<script>
    ...
    export default {
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/journal-entries/'+txn.id })
            }
        },
        ready:function(){},
